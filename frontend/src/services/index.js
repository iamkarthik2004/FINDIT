...
async function uploadImage(image) {
  ...
  const { imageUrl } = await request('/api/uploads/image', { method: 'POST', body: form });
  // The API returns a path so local Vite proxying continues to work. Turn it
  // into a public API URL when the frontend is hosted separately in production.
